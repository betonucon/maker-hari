...
<div class="wrapper">
  ...
  <header class="main-header" style="position: fixed;width: 100%;">
    <div style="width:100%;height:80px;background-color:#bfd0c3d1;background-image:url({{url('img/kota.png')}});background-repeat: repeat-y;">
        <img src="{{url('img/cilegon.gif')}}" style="z-index: 2000;position: absolute;width: 8%;">
        
    </div>
    <nav class="navbar navbar-static-top" style="background-color:#7d9e84">
      <div class="container">
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper" style="margin-top:9%;background-color:#fff">
    <div class="container">
  ...
  <!-- /.content-wrapper -->
  <footer class="main-footer" style="background:#d5e4d8">
    <div class="container">
      <div class="pull-right hidden-xs">
        <b>Version</b> 0.0.1
      </div>
      <strong>Copyright &copy; 2020-2021 <a href="#">GIS Kota Cilegon</a>.</strong> All rights
      reserved.
    </div>
    <!-- /.container -->
  </footer>
