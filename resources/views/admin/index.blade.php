                ...
                <form method="post" id="mysimpan_data" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="kordinat_1"  value="" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Kordinat 2 </label>
                            <input type="text"  name="kordinat_2"  value="" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Alamat</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="pemilik"  value="" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Tanaman</label>
        ...
        function hapus(a){
            if (confirm('Apakah yakin akan menghapus data ini?')) {
                $.ajax({
                    ...
                    success: function(msg){
                            $('#modalloading').modal('hide');
                            $("#tampilkan").load("{{url('lokasi/view_data')}}");
